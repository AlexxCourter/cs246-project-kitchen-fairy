...
public class RecipeEditor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        boolean newRecipe = i.getBooleanExtra("new recipe", false);
        if(!newRecipe){
            Bundle bundle = i.getParcelableExtra("ItemModel_bundle");
            model = (Recipe) bundle.getSerializable("ItemModel");
        }
        ...
        nextScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(model != null){
                    ...
                    id = UserReference.getInstance().getRecipeIDHolder();
                }
                RecipeEditorScreenTwo fragment = RecipeEditorScreenTwo.newInstance(id, items, notes, name, byteArray);
